...
1) ? new util.TextEncoder("utf-8") : void 0, osc.dataView = function(e, t, r) {
    ...
    return r = [ function(e, t) {
        ...
        function u(e, t, r) {
            ...
            for (var n = l(h(r, 8)), s = y, o = 0; o < e.length; o += 8) {
        ...
        Math.pow), n = (i.fromString = u, i.fromValue = p, 4294967296), a = n * n, c = a / 2, w = r(1 << 24), y = r(0), f = (i.ZERO = y, 
        ...
        I.toInt = function() {
            ...
            if (this.unsigned) {
                ...
                if (this.eq(A)) return e.eq(v) || e.eq(S) ? A : e.eq(A) ? v : (i = this.shr(1).div(e).shl(1)).eq(y) ? e.isNegative() ? v : S : (t = this.sub(e.mul(i)), 
                i.add(t.div(e)));
...
(() => {
    ...
    e.open = function() {
        ...
        var i, n;
        this.socketId ? (i = this.options, n = this, t = t || i.remoteAddress, r = void 0 !== r ? r : i.remotePort, 
        chrome.sockets.udp.send(this.socketId, e.buffer, t, r, function(e) {
            e || n.emit("error", "There was an unknown error while trying to send a UDP message. Have you declared the appropriate udp send permissions in your application's manifest file?"), 
            0 < e.resultCode && osc.emitNetworkError(n, e.resultCode);
        })) : osc.fireClosedPortSendError(this);
    }, e.close = function() {
        var e;
