...
!function() {
    ...
    1) ? util.TextDecoder : void 0, osc.dataView = function(e, t, r) {
        ...
        for (var i = osc.readTimeTag(e, r), s = []; r.idx < n; ) {
            var o = osc.readInt32(e, r), a = r.idx + o, c = osc.readPacket(e, t, r, a);
            s.push(c);
        }
        return {
            timeTag: i,
    ...
    return i = {}, n.m = r = [ function(e, t) {
        ...
        var i = 4294967296, a = i * i, c = a / 2, w = r(1 << 24), y = r(0);
        n.ZERO = y;
        var u = r(0, !0);
        n.UZERO = u;
        var d = r(1);
        ...
        I.toInt = function() {
            ...
            for (var i = g(f(e, 6), this.unsigned), s = this, o = ""; ;) {
                var a = s.div(i), c = (s.sub(a.mul(i)).toInt() >>> 0).toString(e);
            ...
            return h += (f += i + (65535 & e.low)) >>> 16, u += (h += n + a) >>> 16, c += (u += r + o) >>> 16, 
            c += t + s, p((h &= 65535) << 16 | (f &= 65535), (c &= 65535) << 16 | (u &= 65535), this.unsigned);
        }, I.subtract = function(e) {
            return l(e) || (e = m(e)), this.add(e.neg());
        }, I.sub = I.subtract, I.multiply = function(e) {
            if (this.isZero()) return y;
            if (l(e) || (e = m(e)), v) return p(v.mul(this.low, this.high, e.low, e.high), v.get_high(), this.unsigned);
            if (e.isZero()) return y;
            if (this.eq(A)) return e.isOdd() ? A : y;
            if (e.eq(A)) return this.isOdd() ? A : y;
            if (this.isNegative()) return e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e).neg();
            if (e.isNegative()) return this.mul(e.neg()).neg();
            if (this.lt(w) && e.lt(w)) return g(this.toNumber() * e.toNumber(), this.unsigned);
            var t = this.high >>> 16, r = 65535 & this.high, n = this.low >>> 16, i = 65535 & this.low, s = e.high >>> 16, o = 65535 & e.high, a = e.low >>> 16, c = 65535 & e.low, u = 0, h = 0, f = 0, d = 0;
            return f += (d += i * c) >>> 16, h += (f += n * c) >>> 16, f &= 65535, h += (f += i * a) >>> 16, 
            u += (h += r * c) >>> 16, h &= 65535, u += (h += n * a) >>> 16, h &= 65535, u += (h += i * o) >>> 16, 
            u += t * c + r * a + n * o + i * s, p((f &= 65535) << 16 | (d &= 65535), (u &= 65535) << 16 | (h &= 65535), this.unsigned);
            ...
            for (r = this; r.gte(e); ) {
                ...
                for (var i = Math.ceil(Math.log(t) / Math.LN2), s = i <= 48 ? 1 : f(2, i - 48), o = g(t), a = o.mul(e); a.isNegative() || a.gt(r); ) a = (o = g(t -= s, this.unsigned)).mul(e);
                o.isZero() && (o = d), n = n.add(o), r = r.sub(a);
            }
            return n;
        }, I.div = I.divide, I.modulo = function(e) {
            return l(e) || (e = m(e)), v ? p((this.unsigned ? v.rem_u : v.rem_s)(this.low, this.high, e.low, e.high), v.get_high(), this.unsigned) : this.sub(this.div(e).mul(e));
