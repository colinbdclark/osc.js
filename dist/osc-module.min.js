...
!function(e, t) {
    ...
    !function() {
        ...
        var e = "undefined" != typeof dcodeIO ? dcodeIO.Long : void 0 !== e ? e : i.isNode ? require("long") : void 0;
        i.dataView = function(e, t, r) {
            ...
            i = void 0 === i ? 0 : i;
            var a;
            return t ? a = new Uint8Array(t.buffer) : (a = new Uint8Array(n), t = new DataView(a.buffer)), 
            t[r](i, e, !1), a;
        ...
        }, i.readInt64 = function(t, r) {
            var n = i.readPrimitive(t, "getInt32", 4, r), a = i.readPrimitive(t, "getInt32", 4, r);
            return e ? new e(a, n) : {
                high: n,
                low: a,
                unsigned: !1
            ...
            var t = (e = i.byteArray(e)).byteLength, r = (t + 3 & -4) + 4, n = new Uint8Array(r), a = new DataView(n.buffer);
            return i.writeInt32(t, a), n.set(e, 4), n;
            ...
            for (var t = [], r = 0; r < e.length; r++) {
                var n, a = e[r];
                n = "object" == typeof a && a.type && void 0 !== a.value ? a : i.isArray(a) ? i.annotateArguments(a) : {
    ...
    var i = i || require("./osc.js"), t = t || require("slip"), r = r || require("events").EventEmitter;
    !function() {
        "use strict";
