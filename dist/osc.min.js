...
!function() {
    ...
    var r = "undefined" != typeof dcodeIO ? dcodeIO.Long : void 0 !== r ? r : osc.isNode ? require("long") : void 0;
    osc.dataView = function(r, e, t) {
        ...
        for (var e = r + "\0", t = e.length + 3 & -4, n = new Uint8Array(t), a = 0; a < e.length; a++) {
        ...
        a = void 0 === a ? 0 : a;
        var o;
        return e ? o = new Uint8Array(e.buffer) : (o = new Uint8Array(n), e = new DataView(o.buffer)), 
        e[t](a, r, !1), o;
        ...
        var n = osc.readPrimitive(e, "getInt32", 4, t), a = osc.readPrimitive(e, "getInt32", 4, t);
        return r ? new r(a, n) : {
            high: n,
            low: a,
            unsigned: !1
        ...
        var e = (r = osc.byteArray(r)).byteLength, t = (e + 3 & -4) + 4, n = new Uint8Array(t), a = new DataView(n.buffer);
        return osc.writeInt32(e, a), n.set(r, 4), n;
        ...
        for (var e = [], t = 0; t < r.length; t++) {
            var n, a = r[t];
            n = "object" == typeof a && a.type && void 0 !== a.value ? a : osc.isArray(a) ? osc.annotateArguments(a) : {
