...
(function () {
    ...
    osc.SerialPort = function () {
        throw new Error("Node.js serial port support has been moved to the node-osc.js-serialport library. " +
        "See https://github.com/colinbdclark/node-osc.js-serialport for more information.");
    };
